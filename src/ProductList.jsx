...
function ProductList({onHomeClick}) {
    ...
    const [addedToCart, setAddedToCart] = useState({}); // Para realizar un seguimiento de qué productos se agregan al carrito.
                        ...
                        {category.plants.map((plant, plantIndex) => ( // Loop through each plant in the current category
                            ...
                            <div className="product-cost">{plant.cost}</div> {/* Display plant cost */}
                                {cart.items.some(item => item.name === plant.name) ? (
                                    ...
                                    <button className="product-button" onClick={() => handleAddToCart(plant)}>Add to Cart</button> // Handle adding plant to cart
                                )}
                            </div>
                        ))}
                        </div>
